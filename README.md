<!-- =======================
     DIRECTORA • README
     MDX-Stable Governance Infrastructure
     ======================= -->
...
```md
![Directora governance flow demo](assets/directora-demo.gif)
```
...
The diagram below intentionally uses conservative Mermaid syntax for GitHub and MDX stability.
...
The optional animated governance flow lives at:
...
The component should remain `.tsx` because it contains typed React/SVG JSX.
